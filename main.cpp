...
/*
 ...
 You will note, that I left both these questions intentionally vague. Its really just to practice getting used to virtual functions and data structures with pointers pointing to those virtual functions. I'll let you be creative, there is no wrong answer in how you approach this.
 */
